...
<body>
    ...
    $userfetch=$result->fetch_assoc();    $userid= $userfetch["pid"];
                        ...
                        <tbody>
                            ...
                            if(($_GET)){
                                ...
                                if(isset($_GET["id"])){
                                    ...
                                    // Calculate the session start time based on the appointment number and weight
                                    $appointmentWeight = 20; // Assuming each appointment has a weight of 20 minutes
                                    $sessionStartTime = date('H:i', strtotime($scheduletime) + ($appointmentWeight * ($apponum - 1) * 60));
                                            ...
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;">
                                                            ...
                                                            Appointment Time : '.$sessionStartTime.'<br>
